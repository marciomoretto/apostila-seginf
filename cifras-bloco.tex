...
\item {\em SubBytes:}
  ...
  Diferente do DES, onde as SBoxes não possuem uma explicação teórica conhecida, a SBox do AES é baseada em operações sobre corpos finitos de Galois\footnote{Um exemplo de como computar o SBox bem como a tabela précomputada em hexadecimal estão no Apêndice \ref{cha:corpos-finitos}}.
