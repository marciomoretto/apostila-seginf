...
Algoritmos validados empiricamente como bons geradores de números pseudo-aleatórios (GNP) podem, portanto, ser utilizados para gerar cifras seguras, pelo menos contra ataques do tipo ciphertext-only.
...
\subsection{Registradores de Deslocamento com Retroalimentação Linear}
\label{sec:lfsr}
...
\begin{center}
  \begin{tikzpicture}[node distance=2cm, thick]
    ...
    \node[draw, rectangle, minimum width=1cm, minimum height=1cm] (s1) at (1,0) {1};
    \node[draw, rectangle, minimum width=1cm, minimum height=1cm] (s2) at (2,0) {0};
    \node[draw, rectangle, minimum width=1cm, minimum height=1cm] (s3) at (3,0) {1};
...
\begin{itemize}
\item[] O novo bit a ser inserido na primeira posição é: $1 \xor 1 = 0$
\item[] O primeiro bit produzido é $1$ que é o bit que estava na última posição.
\end{itemize}
...
\begin{center}
  \begin{tikzpicture}[node distance=2cm, thick]
    % Nós para os números
    \node[draw = none] (s) at (0,0) {$s$};
    \node[draw, rectangle, minimum width=1cm, minimum height=1cm] (s1) at (1,0) {0};
    \node[draw, rectangle, minimum width=1cm, minimum height=1cm] (s2) at (2,0) {1};
    \node[draw, rectangle, minimum width=1cm, minimum height=1cm] (s3) at (3,0) {0};
    \node[draw = none, rectangle, minimum width=1cm, minimum height=1cm] (s4) at (4,0) {};
...
\begin{itemize}
\item[] O novo bit a ser inserido na primeira posição é: $0 \xor 0 = 0$
\item[] O segundo bit produzido é $0$ que é o bit que estava na última posição.
\end{itemize}
...
\begin{itemize}
\item[] O novo bit a ser inserido na primeira posição é: $0 \xor 1 = 1$
\item[] O terceiro bit produzido é $1$ que é o bit que estava na última posição.
\end{itemize}
